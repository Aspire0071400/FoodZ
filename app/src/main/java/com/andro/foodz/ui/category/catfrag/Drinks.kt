...
import com.andro.foodz.databinding.ActivityDrinksBinding
...
class Drinks : Fragment() {
    lateinit var fragmentDrinks : ActivityDrinksBinding
    private var data = arrayListOf<CatNavDataModel>()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View {
        fragmentDrinks = ActivityDrinksBinding.inflate(inflater)
        fetchData()
        return fragmentDrinks.root
    }
    ...
    private fun fetchData() {
        ...
        val stringRequest = StringRequest(
            Request.Method.GET,"https://foodzproject.000webhostapp.com/fetch_data.php" , {
                ...
                fragmentDrinks.cat4NavDataViewcycle.layoutManager = LinearLayoutManager(context)
                fragmentDrinks.cat4NavDataViewcycle.adapter = CatNavDataAdapter(data)
