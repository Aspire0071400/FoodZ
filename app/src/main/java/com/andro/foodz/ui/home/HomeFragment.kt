    ...
    private fun fetchData() {
        ...
        val stringRequest: StringRequest = StringRequest(
            Request.Method.GET,"https://foodzproject.000webhostapp.com/fetch_data.php",{
                val homenavdataArray:JSONArray=JSONArray(it)
                ...
                fragmenthome.homeNavDataView.layoutManager=LinearLayoutManager(context)
                fragmenthome.homeNavDataView.adapter=HomeNavDataAdapter(data)
